...
const Resume = () => {
    ...
    return (
        ...
        <div className="min-h-screen w-[90%] lg:w-[50%] md:w-[50%] m-auto my-5">

            <div className="my-10 text-center">
                <button className={`border duration-300 text-sm font-semibold  shadow-md hover:-translate-y-1 rounded-md py-2 px-2  ${theme === 'dark' ? 'border-yellow-500 hover:bg-yellow-500' : ' border-blue-500 hover:bg-indigo-700 hover:text-white'}`}>
