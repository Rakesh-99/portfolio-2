...
const Home = () => {
    ...
    return (
        <>
            {/* Home Section */}
            <section id="home" className="duration-500 py-5 transition-all select-none grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 min-h-screen flex items-center">
                {/* left content  */}
                <div className="flex flex-col gap-10">
                    ...
                    <div className="flex md:mt-20 lg:mt-20 mt-10 flex-col justify-center">
                        ...
                        <div className=" md:w-[70%] lg:w-[70%] w-[90%] m-auto">
                            <h1 className='flex font-mono items-center gap-1 lg:text-2xl text-xl md:text-2xl font-medium'>
                                I am
                                <span className='mt-2 bg-clip-text bg-gradient-to-r from-cyan-600 via-cyan-500 to-yellow-400 inline-block text-transparent'> RAKESH KUMAR PARIDA.
                                </span>
                            </h1>
                            <TypeWriterEffect
                                textStyle={{
                                ...
                                multiText={['Fullstack Stack Developer']}
                                multiTextDelay={1000}
                                typeSpeed={100}
                                multiTextLoop
                            />
                    ...
                    <div className="flex flex-col">
                        <div className="flex font-[500] text-3xl items-center  md:w-[70%] lg:w-[70%] w-[95%] m-auto gap-2 ">
                            ...
                            <h1 className=' bg-clip-text bg-gradient-to-r from-cyan-600 via-yellow-500 to-indigo-400 inline-block text-transparent'> introduce</h1>
